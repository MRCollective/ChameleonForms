...
{
    public class Section<TModel, TTemplate> : FormComponent<TModel, TTemplate> where TTemplate : IFormTemplate, new()
    {
        private readonly string _title;

        public Section(Form<TModel, TTemplate> form, bool isSelfClosing, string title) : base(form, isSelfClosing)
        {
            _title = title;
        }
