...
namespace ChameleonForms
{
    ...
    interface IForm
    {
        IForm<TModel> CreateChildProxy<TModel>(object parentExpression);
    }
    ...
    public class Form<TModel> : IForm<TModel>, IForm
    {
        ...
        IForm<TChild> IForm.CreateChildProxy<TChild>(object parentExpression)
        {
            Expression<Func<TModel, TChild>> parEx = parentExpression as Expression<Func<TModel, TChild>>;
            return new ProxyForm<TModel, TChild>(this, parEx);
        }
    }
