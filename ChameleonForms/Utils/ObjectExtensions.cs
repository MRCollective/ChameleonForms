...
namespace ChameleonForms.Utils
{
    ...
    {
        // From: https://github.com/ASP-NET-MVC/aspnetwebstack/blob/master/src/System.Web.WebPages/Html/HtmlHelper.cs and https://github.com/ASP-NET-MVC/aspnetwebstack/blob/master/src/System.Web.WebPages/Utils/HtmlAttributePropertyHelper.cs
        // Copyright (c) Microsoft Open Technologies, Inc. All rights reserved. See License.txt at https://github.com/ASP-NET-MVC/aspnetwebstack/blob/master/License.txt for license information.
        /// <summary>
        ...
        public static IDictionary<string, object> AnonymousObjectToHtmlAttributes(this object htmlAttributes)
        {
            ...
            if (htmlAttributes != null)
            {
                ...
                {
                    result.Add(property.Name.ToLower(), property.GetValue(htmlAttributes));
                }
            }
