...
namespace ChameleonForms
{
    ...
    public interface IViewWithModel<TModel>
    {
        ...
        /// <summary>
        /// State of the model where the key is the binding name of the field and the value is the model state for that field.
        /// </summary>
        IDictionary<string, ModelState> ModelState { get; }
        ...
        /// <summary>
        /// Add HTML attributes for a field that has a validation error.
        /// </summary>
        /// <typeparam name="TProperty">The type of the property</typeparam>
        /// <param name="attrs">Field attributes to modify</param>
        /// <param name="fieldProperty">The property for the field</param>
        /// <param name="modelState">The errors for the field</param>
        void AddValidationErrorAttributes<TProperty>(HtmlAttributes attrs, Expression<Func<TModel, TProperty>> fieldProperty, ModelState modelState);
